...
const mapDispatchToProps = dispatch => {
    return {
        onIngredientAdded: (ingName) => dispatch({type: actionTypes.ADD_INGREDEINT, ingredientName: ingName}),
        onIngredientDeleted: ingName => dispatch({ type: actionTypes.DELETE_INGREDEINT, ingredientName: ingName})
    }
}
